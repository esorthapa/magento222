...
class Slider extends AbstractModel
{
    ...
    /**
     * Allow to show title yes or no.
     */
    const SHOW_TITLE_YES = 1;
    const SHOW_TITLE_NO = 2;

    /**
     * style custom content yes or no.
     */
    const STYLE_CONTENT_YES = 1;
    const STYLE_CONTENT_NO = 2;

    /**
     * sort type of banners in a slider random or orderly.
     */
    ...
    /**
     * position code of note slider with different position.
     */
    ...
    public function __construct(
        ...
        \Javra\Bannerslider\Model\ResourceModel\Slider $resource,
        \Javra\Bannerslider\Model\ResourceModel\Slider\Collection $resourceCollection
    ) {
        parent::__construct(
            $context,
            $registry,
