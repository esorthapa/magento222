...
namespace Javra\Bannerslider\Block\Adminhtml\Report;

use Javra\Bannerslider\Model\ResourceModel\Report\Collection as ReportCollection;
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        /** @var \Javra\Bannerslider\Model\ResourceModel\Report\Collection $collection */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'filter' => false,
                'index' => 'imagename',
                'renderer' => 'Javra\Bannerslider\Block\Adminhtml\Report\Helper\Renderer\Image',
            ]
        );
        $this->addColumn(
            'date_click',
