...
namespace Javra\Bannerslider\Block\Adminhtml\Slider\Edit\Tab;

use Javra\Bannerslider\Model\Status;
class Banners extends \Magento\Backend\Block\Widget\Grid\Column\Extended
{
    /**
     * banner factory.
     *
    ...
    {
        /** @var \Javra\Bannerslider\Model\ResourceModel\Banner\Collection $collection */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'class' => 'xxx',
                'width' => '50px',
                'renderer' => 'Javra\Bannerslider\Block\Adminhtml\Banner\Helper\Renderer\Image',
            ]
        );
        $this->addColumn(
            'title',
        ...
        $this->addColumn(
            ...
            [
                ...
                'renderer' => 'Javra\Bannerslider\Block\Adminhtml\Slider\Edit\Tab\Helper\Renderer\EditBanner',
            ]
        );
